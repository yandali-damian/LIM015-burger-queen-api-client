          ...
          <Toolbar className={classes.ToolbarColor}>
            ...
            <ThemeProvider theme={theme}>
              <ButtonGroup variant="contained" color="primary">
                <Button size="small" onClick={() => history.push('/customers')}><ArrowBackIosTwoToneIcon /></Button>
                <Button size="small" onClick={() => history.push('/')}><ExitToAppIcon /></Button>
              </ButtonGroup>
            </ThemeProvider>
          </Toolbar>
        </AppBar>
                  ...
                  desayunos.map((desayuno) => (
                    <li key={desayuno._id}>
                      <Grid container direction='row'>
                        <Grid item xs={7}>
                          <Button color="secondary" onClick={AgregarPedido(desayuno.name)}>{desayuno.name}</Button>
                        </Grid>
                        <Grid item xs={4}>
          ...
          <Grid item xs={7} component='main' sx={{ backgroundColor: 'rgba(1 1 1 / 34%)' }}>
            <Grid container direction="row" className={classe.containerOrderList}>
              <Grid item xs={4} justifyContent="center">
                <input placeholder='Nombre del cliente' style={{ color: '#000', background: '#fff', borderRadius: '20px', padding: '12px' }} value={localStorage.getItem('Mesa')} />
              </Grid>
              <Grid item xs={8} >
            ...
            <Grid container direction="row" className={classe.containerOrderList}>
              <Grid item xs={4}>
                <ThemeProvider theme={themepedido}>
                  <Box sx={{ "& > :not(style)": { m: 0.2 } }}>
                    ...
                    <input style={{ color: '#000', background: '#fff', borderRadius: '7px', padding: '12px', width: '20px' }} value={count} />
              ...
              <Grid item xs={6}>
                {desayunos && (desayunos.map((desayuno) => (
                  <span className='spanPedidos'></span>
                )))}
              </Grid>
              <Grid item xs={2}>
